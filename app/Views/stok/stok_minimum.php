        ...
        <div class="modal-content">
            <form action="<?= base_url('update_stokminimum') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3"><label hidden>Id Unit</label><input hidden type="text" class="form-control" name="idunit"
                            id="edit-idunit" required></div>
                    <div class="mb-3"><label hidden>Idbarang</label><input hidden type="text" class="form-control" name="idbarang"
                            id="edit-idbarang" required></div>
                    <div class="mb-3"><label>Stok Minimum</label><input type="text" class="form-control" name="stokminimum" id="stokminimum"
                            required></div>
                </div>
