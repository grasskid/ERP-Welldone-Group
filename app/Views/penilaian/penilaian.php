                ...
                <?php if (!empty($penilaian)): ?>
                    <?php foreach ($penilaian as $row): ?>
                        <tr>
                            ...
                            <td><?= esc(date('d-m-Y', strtotime($row->updated_on)) ?? 'tidak ada record') ?></td>
                            <td>
                                <button type="button" class="btn btn-warning edit-button" data-bs-toggle="modal"
                                    data-bs-target="#edit-penilaian-modal"
                                    data-idpenilaian="<?= esc($row->idpenilaian) ?>"
                                    data-aspek="<?= esc($row->aspek) ?>"
...
<div class="modal fade" id="input-penilaian-modal" tabindex="-1" aria-labelledby="inputPenilaianModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= base_url('insert_penilaian') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2" name="pegawai_idpegawai" id="input-pegawai_idpegawai" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_penilaian" id="tanggal_penilaian" required>
                    </div>
                </div>
            ...
            <form action="<?= base_url('update_penilaian') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_penilaian" id="edit-tanggal_penilaian" required>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('#zero_config').addEventListener('click', function(e) {
            ...
            if (editBtn) {
                ...
                document.getElementById('edit-idpenilaian').value = editBtn.getAttribute('data-idpenilaian');
                ...
                document.getElementById('edit-tanggal_penilaian').value = editBtn.getAttribute('data-tanggal_penilaian');
            ...
            if (deleteBtn) {
                document.getElementById('delete-id_penilaian').value = deleteBtn.getAttribute('data-idpenilaian');
            }
        });
    });
</script>
