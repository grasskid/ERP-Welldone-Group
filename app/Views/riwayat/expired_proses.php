<div class="card shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body d-flex align-items-center justify-content-between p-4">
        <h4 class="fw-semibold mb-0">Riwayat Expired Proses</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item">
                    <a class="text-muted text-decoration-none" href="<?= base_url('/') ?>">Riwayat</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Expired Proses</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <form action="<?php echo base_url('riwayat_expired_service/export') ?>" method="post" enctype="multipart/form-data">
