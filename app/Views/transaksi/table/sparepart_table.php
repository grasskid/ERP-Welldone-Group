<form action="" id="form-sparepart">
    ...
    <script>
        ...
        document.getElementById('add-selected-sparepart').addEventListener('click', function() {
            ...
            const currentIndex = tbody.children.length; // untuk urutan index
    ...
    <td><input type="number" class="form-control harga" name="produk[${rowIndex}][harga]" value="${harga}"></td>
    <td><input type="number" class="form-control qty" name="produk[${rowIndex}][jumlah]" value="1" min="1"></td>
    <td><input type="number" class="form-control diskon-item" name="produk[${rowIndex}][diskon]" value="0" min="0"></td>
