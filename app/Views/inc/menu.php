<aside class="left-sidebar with-vertical">
    ...
    <div class="brand-logo d-flex justify-content-center align-items-center py-3">
        ...
        <a href="<?php echo base_url('template/') ?>dark/index.html" class="text-nowrap logo-img">
            <img src="<?php echo base_url('template/') ?><?= env('app.logo', 'assets/images/logo_urban.png') ?>"
                class="dark-logo w-100 h-auto" alt="Logo-Dark" />
            <img src="<?php echo base_url('template/') ?><?= env('app.logo', 'assets/images/logo_urban.png') ?>"
                class="light-logo w-100 h-auto" alt="Logo-light" />
        </a>
    ...
    <div class="scroll-sidebar" data-simplebar>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="mb-0">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="/stok_minimum" aria-expanded="false">
                        <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                            <iconify-icon icon="solar:screencast-2-line-duotone" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu ps-1">Stok Minimum</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link primary-hover-bg" href="/promosi_whatsapp"
                        aria-expanded="false">
                        <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                            <iconify-icon icon="solar:screencast-2-line-duotone" class="fs-6"></iconify-icon>
                        </span>
                        <span class="hide-menu ps-1">Whatsapp</span>
                    </a>
                </li>
