<div class="card shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body d-flex align-items-center justify-content-between p-4">
        <h4 class="fw-semibold mb-0">Datamaster Bank</h4>
    ...
    <div class="table-responsive mb-4 px-4">
        <table class="table border text-nowrap mb-0 align-middle" id="zero_config">
            <thead class="text-dark fs-4">
                <tr>
                    <th>
                        <h6 class="fs-4 fw-semibold mb-0">Nama Bank</h6>
                    </th>
                    <th>
                        <h6 class="fs-4 fw-semibold mb-0">Atas Nama</h6>
                    </th>
                    <th>
                        <h6 class="fs-4 fw-semibold mb-0">No Rekening</h6>
                    </th>
                    <th>
                        <h6 class="fs-4 fw-semibold mb-0">Gambar QRIS</h6>
                    </th>
                </tr>
            </thead>
            <tbody>
