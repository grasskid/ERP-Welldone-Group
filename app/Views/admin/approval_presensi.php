...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <div class="mb-3 px-4">
        ...
        <div style="display: flex; justify-content: right;">
            <button type="button" id="btn-absen-masuk" data-bs-toggle="modal"
                data-bs-target="#modal-konfirmasi-absen-masuk"
                style="width: 100px; height: 30px; color: white; background-color: cornflowerblue; outline: none; border: none; border-radius: 10px;">Tambah
            </button>
        </div>
...
<div class="modal fade" id="modal-konfirmasi-absen-pulang_manual" tabindex="-1"
    aria-labelledby="konfirmasiAbsenPulangLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
