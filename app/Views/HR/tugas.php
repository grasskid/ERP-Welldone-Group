...
<body>
    ...
    <div class="card w-100 position-relative overflow-hidden">
        ...
        <form method="get" class="mb-4" style="padding-left: 20px;">
            <div class="row">
                <div class="col-md-3">
                    <label style="padding-bottom: 5px;">Tanggal Awal</label>
                    <input type="date" name="tanggal_awal" class="form-control" value="<?= esc($tanggal_awal) ?>">
                </div>
                <div class="col-md-3">
                    <label style="padding-bottom: 5px;">Tanggal Akhir</label>
                                            ...
                                            <div class="task-header">
                                                <div>
                                                    <h4 data-item-title="<?= esc($t->nama_tugas) ?>">
                                                        <?= esc($t->nama_tugas) ?><br>
                                                        <small class="text-muted"><?= esc($t->NAMA_AKUN) ?></small>
                                                    </h4>
                                                </div>
                                                <div class="dropdown">
    ...
    <!-- Modal informasi foto -->
    <div class="modal fade" id="modalFoto" tabindex="-1" aria-labelledby="modalFotoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content  border-0">
                <div class="modal-body text-center p-0" style="overflow: hidden;">
                    <br>
                    <img id="modalGambar" src="" class="img-fluid rounded shadow" alt="Foto Tugas"
                        style="transition: transform 0.3s ease; cursor: grab;">
                </div>
                <div class="modal-footer justify-content-center gap-2 flex-wrap bg-white rounded-bottom">
                    ...
                    <button type="button" class="btn btn-danger" onclick="tutupModal()">Tutup</button>
                </div>
            </div>
        </div>
    </div>
