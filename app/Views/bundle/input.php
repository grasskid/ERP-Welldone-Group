...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <form action="<?php echo base_url('insert_bundle') ?>" enctype="multipart/form-data" method="post">

        <div class="mb-3" style="padding: 20px;">
            <label for="nama_bundle" class="form-label">Nama Bundle</label>
            <input style="width: 400px;" type="text" class="form-control" id="nama_bundle"
                name="nama_bundle" required>
        </div>
