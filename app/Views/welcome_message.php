            ...
            <div class="card-body border-bottom position-relative">
                ...
                <div class="mt-6">
                    ...
                    <div class="man-working-on-laptop">
                        <img src="<?php echo base_url('template/') ?>assets/images/backgrounds/man-working-on-laptop.png" alt=""
                            class="img-fluid">
                    </div>
                </div>
            </div>
                        ...
                        <div class="my-6 py-4">
                            ...
                            <div class="progress bg-light-subtle w-100 my-2">
                                <div class="progress-bar text-bg-primary" role="progressbar"
                                    aria-label="Example 8px high" style="width: 80%;"
                    ...
                    <table class="table text-nowrap customize-table mb-0 align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center product text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/products/product-5.png"
                            ...
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center product text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/products/product-6.png"
                                            class="img-fluid flex-shrink-0" width="60" height="60">
                                        <div class="ms-3 product-title">
                                            <h6 class="fs-4 mb-0 text-truncate-2">Apple MacBook Pro
                                                13 inch-M1-8/256GB-space</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center product text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/products/product-7.png"
                                            class="img-fluid flex-shrink-0" width="60" height="60">
                                        <div class="ms-3 product-title">
                            ...
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center product text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/products/product-8.png"
                                            class="img-fluid flex-shrink-0" width="60" height="60">
                                        <div class="ms-3 product-title">
                            ...
                            <tr>
                                <td class="ps-0 border-bottom-0">
                                    <div class="d-flex align-items-center product text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/products/product-9.png"
                                            class="img-fluid flex-shrink-0" width="60" height="60">
                                        <div class="ms-3 product-title">
                    ...
                    <table class="table mb-0 align-middle text-nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/profile/user-2.jpg" alt=""
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/profile/user-3.jpg" alt=""
                                            class="img-fluid rounded-circle flex-shrink-0"
                                            width="32" height="32">
                                        <div class="ms-7">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/profile/user-4.jpg" alt=""
                                            class="img-fluid rounded-circle flex-shrink-0"
                                            width="32" height="32">
                                        <div class="ms-7">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/profile/user-5.jpg" alt=""
                                            class="img-fluid rounded-circle flex-shrink-0"
                                            width="32" height="32">
                                        <div class="ms-7">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center text-truncate">
                                        <img src="<?php echo base_url('template/') ?>assets/images/profile/user-6.jpg" alt=""
                                            class="img-fluid rounded-circle flex-shrink-0"
                                            width="32" height="32">
                                        <div class="ms-7">
                        ...
                        <ul class="pagination mb-0 align-items-center">
                            <li class="page-item"><a
                                    ...
                                    <iconify-icon icon="solar:alt-arrow-left-line-duotone"
                                        class="fs-5"></iconify-icon>Previous
                                </a></li>
                            <li class="page-item"><a
                                    class="page-link border-0 d-flex align-items-center fw-normal"
                                    href="#">Next<iconify-icon
                                        icon="solar:alt-arrow-right-line-duotone" class="fs-5">
                                    </iconify-icon></a></li>
                        </ul>
                    </nav>
                </div>
