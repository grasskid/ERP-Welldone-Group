...

{
    ...
    public function insert()
    {
        ...
        $kpi = $this->request->getPost('template_penilaian_idtemplate_penilaian');
        $kpiutama = $this->request->getPost('template_kpi_idtemplate_kpi');
        ...
        $data = [
            ...
            'status' => $status,
            'jumlah' => $jumlah,
            'template_penilaian_idtemplate_penilaian' => $kpi,
            'template_kpi_idtemplate_kpi' => $kpiutama,
