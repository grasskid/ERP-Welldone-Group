...
class StokHP extends BaseController

{

    protected $AuthModel;
    protected $StokHPModel;
    protected $UnitModel;

    public function __construct()
    {
        $this->AuthModel = new ModelAuth();
        $this->StokHPModel = new ModelStokHP();
    ...
    public function index()
    {
        ...
        $data =  array(
            'akun' => $akun,
            'stok' => $this->StokHPModel->getStokHP(),
            'body'  => 'stok/stok_hp',
    ...
    public function export()
    {
        ...
        //     $tanggalAwal = $this->StokHPModel->getMinTanggalStok();
        // }
        ...
        $stok = $this->StokHPModel->exportfilter( $unit, $statusPpn);
        // $stok = $this->StokHPModel->exportfilter($tanggalAwal, $tanggalAkhir, $unit, $statusPpn);
